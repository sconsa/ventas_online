                ...
                <!-- navogation div starts here-->
                    ...
                    <div id="tabs1" >
                        <ul>
                            ...
                            if($item && $_layoutParams['menu'][$i]['id'] == $item ){ // si se envia un item y este item es igual al id del menu, la variable item stile sera igual a current marcando el menu si este esta seleccionado
                                $_item_style = 'current'; // Esta clase marca el menú si este esta seleccionado
                            } else {
                                $_item_style = '';
                            }
